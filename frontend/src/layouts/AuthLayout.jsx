function AuthLayout({ eyebrow, title, description, children, footer }) {
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(201,119,92,0.18),transparent_30%),linear-gradient(180deg,#151311_0%,#0f0e0d_100%)] px-4 py-10 text-[color:var(--on-dark)]">
